...
class FadeToBlackRateUpdateCommand extends CommandBase_1.DeserializedCommand {
    ...
    applyToState(state) {
        ...
        mixEffect.fadeToBlack = Object.assign(Object.assign({ isFullyBlack: false, inTransition: false, remainingFrames: 0 }, mixEffect.fadeToBlack), { rate: this.properties.rate });
